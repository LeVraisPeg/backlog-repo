...
La variance fontionnelle de la fonction $x\mapsto Laplace(b) $ est donnée par : $ \int_{-0.5}^{0.5} (Laplace(b) - \overline{Laplace}) dx$, où $\overline{Laplace}$ est la moyenne de la fonction $x\mapsto Laplace(b)$ sur l'intervalle $]-0.5, 0.5[$.\\	
...
la génèration de bruit tout en maximisant la variance du bruit généré pour augmenter la confidentialité des données.
