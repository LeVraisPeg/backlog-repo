...
\subsection{Implémentation dans le système}
    ...
    de recommandation à froid sont relativement stables entre les données bruitées et non bruitées, 
    malgré l’ajout d’un bruit correspondant à un budget de confidentialité fixé à $b = 0{,}5$. Dans 
    ...
    distincts recommandés d’environ 2 par utilisateur pour 20 films recommandé. En revanche, il parvient à une  
