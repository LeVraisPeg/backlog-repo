...
Ce choix est motivé par le contexte de ce projet. En effet, les utilisateurs peuvent modifier leur evaluation d'un film. Dans cet objectif, et contrairement au 
...
En complément, et comme présenté précédemment, nous avons considéré l'utilisation du mécanisme exponentiel pour la recommandation à froid d'un utilisateur.
