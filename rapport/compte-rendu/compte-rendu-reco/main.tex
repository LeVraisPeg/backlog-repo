...
\begin{itemize}
    \item \textbf{Les méthodes basées sur le contenu (content-based)} utilisent les caractéristiques des items — ici, 
    ...
    de bénéficier des avantages des deux. L’ajout progressif d’interactions utilisateur permet ainsi d’améliorer la 
    précision des recommandations.
    \item \textbf{Les méthodes statistiques globales} reposent sur des données agrégées, telles que la moyenne des notes 
    attribuées à chaque film. Elles sont bien adaptées aux systèmes sans personnalisation, mais nécessitent une base de 
    données suffisamment riche pour être fiables. Par exemple, une moyenne de notes n’est pertinente que si un film a 
    reçu un nombre significatif d’évaluations.
    \item \textbf{Les méthodes basées sur le clustering} regroupent les utilisateurs ou les items selon leurs caractéristiques 
    communes, comme présenté par Nguyen et al. \cite{clustering}. Cela permet de générer des recommandations en s’appuyant sur 
    la structure des groupes formés.
\end{itemize}
...
\begin{itemize}
    ...
    $ $\\
    Le système de recommendation mit en place se base sur un clustering non supervisé des films, à l'image de .... , ainsi que sur des statistiques globales issues de la base de données.
...
\bibitem{tfhe}
Chandran B., Ghoshal A., Halevi S., Ranellucci S., Smart N. P. 
\emph{Faster Homomorphic Comparison Operations for BGV and BFV}, 
Cryptology ePrint Archive, Report 2023/958. 
...
\bibitem{matrix_fac}
Elie A. \emph{Deep Dive into Matrix Factorization for Recommender Systems: From Basics to Implementation}
\url{https://medium.com/@eliasah/deep-dive-into-matrix-factorization-for-recommender-systems-from-basics-to-implementation-79e4f1ea1660}

\bibitem{programming_dp}
Programming Differential Privacy. \emph{Chapter 9 — Fully Homomorphic Encryption (FHE)}, 
\url{https://programming-dp.com/ch9.html}

\bibitem{nguyen2024_ere}
Nguyen, Q., Naghiaei, M., and Zhang, Y. \emph{Cold-start Recommendation by Personalized Embedding Region Elicitation}, arXiv preprint arXiv:2406.00973, 2024.\\
\url{https://arxiv.org/abs/2406.00973}


\bibitem{end_size}
I. Chillotti, N. Gama, M. Georgieva, and M. Izabachène.
\emph{Faster Fully Homomorphic Encryption: Bootstrapping in Less Than 0.1 Seconds}.
Cryptology ePrint Archive, Report 2016/870, 2016.
