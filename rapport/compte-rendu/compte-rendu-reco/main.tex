...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        ayant un nombre d’évaluations inférieur ou égal à un seuil (ici, 0). Cette approche permet alors de recommender des films étant globalement appréciés par les utilisateurs l'ayant noté et donc de recommander des films qui 
...
\subsection{Implémentation dans le système}
    ...
    $ $\\
    Pour les systèmes de recommendation à froid, la notions de précision et de recall ne sont pas adaptées, car le système ne dispose pas d'informations sur les préférences des utilisateurs,
    ne pouvant, de ce fait, pas prévoir de films à recommender.
    Notre évaluation repose donc sur les critères suivants :
    \begin{itemize}
        \item Représenter les différents films 
    \end{itemize}
...
\subsubsection{Système de recommendation à froid}
    ...
    \\
    Enfin, comme mentionné précédemment, le système de recommandation à froid repose sur une représentation 
...
\centering
\caption{Résultats expérimentaux du système de recommandation à froid \textbf{sans bruit}}
\label{tab:resultats_sb}
\resizebox{\textwidth}{!}{%
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|c|}
\hline
k & Clusters & Genre Div. & Inner Div. & Unk. Cov. & Cov. & Film/User & Clust/User & Few R/Reco & Resp. Time (s) & Init (s) & Train (s) \\
\hline
\textbf{sr} & 2 & 0.456 & 0.456 & 0.0025 & 0.703 & 8.057 & 2.0 & 0.044 & 0.0267 & 0.032 & 94.74 \\
\hline
...
\begin{sidewaystable}[h!]
\centering
\caption{Résultats expérimentaux du système de recommandation à froid \textbf{avec bruit}}
...
k & Clusters & Genre Div. & Inner Div. & Unk. Cov. & Cov. & Film/User & Clust/User & Few R/Reco & Resp. Time (s) & Init (s) & Train (s) \\
\hline
\textbf{sr} & 2 & 0.466 & 0.466 & 0.0018 & 0.762 & 7.936 & 2.0 & 0.033 & 0.0325 & 0.031 & 100.69 \\
\hline
