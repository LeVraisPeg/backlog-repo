...
\begin{itemize}
    ...
    \item \textbf{Chiffrement quasi-entièrement homomorphe} : Il permet de réaliser un nombre limité d'opérations sur des données chiffrées, pour plusieurs lois, par exemple l'addition et la multiplication, mais la capacité est limitée à cause de l'accumulation de bruit.  
