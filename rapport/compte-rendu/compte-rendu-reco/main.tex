...
\subsection{Système de recommendation à froid}
...
\begin{itemize}
    ...
    \item L'utilisation de "bootstrapping" \cite{boots} pour limiter l'accumulation de bruit peut augmententer le temps de calcul avec un nombre d'opérations significatifs réalisées.
