...
\subsection{Résumé}
$ $\\
Dans ce projet, nous avons tenter de mettre en place un système de recommandation de films tout en respectant la confidentialité des données des utilisateurs.
Pour la recommandation de films, nous avons opté pour la mise en place de deux système de recommandation : un système de recommandation pour les utilisateurs connus du système, 
...
Pour la confidentialité des données, nous avons choisi la mise en place mannuelle du mécanisme de Laplace pour la génération de bruit, permettant ainsi un meilleur
contrôle de la génération du bruit, ainsi que l'utilisation d'un mécanisme exponentiel pour la sélection aléatoire de films recommandés pour les recommandations à froid.
...
\\
L'ensemble de données sur lequel nous avons travaillé est un jeu de données MovieLens, qui contient des informations sur les films ainsi que les évaluations des utilisateurs, représentant dans notre cas, environ 
...
\\
Avec ce budget de confidentialité, nous avons pu voir que le système de recommandation à chaud atteint une précision de 72,2\% et un rappel de 69,1\%, avec un temps de réponse moyen de 0.03 seconde.
Le système de recommandation à froid, quant à lui, permet de représenter en moyenne 9 à 11 clusters différents dans les recommandations, avec une représentation des genres de la base de donné d'environ 60\% tout 
en recommandant en moyenne 19\% de films sans évaluation. De plus, le système de recommandation à froid permet d'atténuer la redondance de recommandations en recommandant en moyenne 2 films distincts par utilisateur. 
\\
toutefois, certaines améliorations peuvent être envisagées.
